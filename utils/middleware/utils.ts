...
): NextMiddleware => async (req, event) => {
...
export const isStaticFileRoute = (req: NextRequest): boolean => PUBLIC_FILE.test(req.nextUrl.pathname);

export const isVercelRoute = (req: NextRequest): boolean => req.nextUrl.pathname.startsWith('/monitoring');
